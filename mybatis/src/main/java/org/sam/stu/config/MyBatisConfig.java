...
@MapperScan(basePackages={"org.sam.stu.mapper"}, sqlSessionFactoryRef = "sqlSessionFactoryForPrimary")
public class MyBatisConfig {
	...
	public SqlSessionFactory sqlSessionFactoryForPrimary() throws Exception {
		...
		//加入扫描Mapper.xml文件
		 ...
		 ssfb.setMapperLocations(resolver.getResources("classpath*:mybatis/*Mapper.xml"));
